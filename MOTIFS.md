...
| Group boxes | Dark surface lift (`_DARK_SURFACE_BG`), light border `#313244` / `#45475a`. **Octopus Live Monitor** title chip (`QGroupBox#octopusLiveMonitor::title`): light glass wash `rgba(205,214,244,22)` + `1px solid` `_DARK_OVERLAY` (`#6c7086`), 3px radius — in `ui/styles.py` |
