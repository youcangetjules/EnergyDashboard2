...
<p>
On the top chart, each <b>London calendar day</b> in view is annotated with <b>Total imported</b> (kWh, top-right of that day) and <b>Total exported</b> (kWh, bottom-left); partial days count only intervals visible in the window. In Cost view those top-chart notes are pounds instead, marked settled or est.</p>
<p>
In <b>Power</b> and <b>Cost</b> the <b>bottom chart</b> is always the same
four energy measures, resetting at each <b>London calendar midnight</b>:
...
In <b>Cost</b> view the <b>top chart</b> and the cards show pounds (Agile spot
price × energy, standing charge not included). Today’s money line is the
estimate. The bottom chart still stays in kWh. The <b>Import cost</b> /
<b>Export credit</b> cards show this Hours window as the large figure, with a
smaller <b>(Today: £…)</b> for London midnight to now so a 24&nbsp;h window is
not mistaken for today’s bill so far.</p>
"""
