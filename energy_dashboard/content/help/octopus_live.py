...
<p>
<b>View: Power / Cost</b> sits next to the Hours radios. <b>Power</b> is watts and kWh. <b>Cost</b> is that same energy times the Agile spot price (the half-hour unit rate, including VAT — the import and export tariffs from Forecasts / Setup). Positive money is what you pay to import; negative money is export credit. The standing charge is not included, so this is not the final bill.</p>
<p>
