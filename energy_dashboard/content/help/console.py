...
<p>
A <b>segmentation fault</b> or <b>abort</b> never reaches this log on its own — the process is already dead. Those are written to <code>~/.energy_dashboard_crash.log</code> (Python stacks, plus the system core-dump stack), and the next launch adds a <b>Crash</b> line here. <b>Clear</b> does not remove that crash log.</p>
<p>
