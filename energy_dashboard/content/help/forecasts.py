...
<li>
For multi-face roofs, open <b>Physical Plant → Roof layout</b> (Google Earth / KML + panel types), then <b>Apply to Forecasts</b> — Fetch Forecasts sums one PV curve per face.</li>
</ul>
"""
